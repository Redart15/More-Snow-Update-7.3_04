...
public class BlockModelSnowyStairsPainted<T extends BlockLogicSnowy<?> & PaintedBlock> extends BlockModelSnowyStairs<T>{
	public BlockModelSnowyStairsPainted(Block<T> block, BlockModel<?> layerModel) {
