...
import net.minecraft.core.world.generate.feature.WorldFeatureNetherScatterBoulderMagmatic;
import net.minecraft.core.world.pos.TilePos;
import org.spongepowered.asm.mixin.Mixin;
import org.spongepowered.asm.mixin.injection.At;

@Mixin(value = WorldFeatureNetherScatterBoulderMagmatic.class, remap = false)
public abstract class WorldFeatureMagmaMixinAshenPile {

	@WrapOperation(method = "place", at = @At(value = "INVOKE", target = "Lnet/minecraft/core/world/generate/feature/WorldFeatureNetherScatterBoulderMagmatic;placeIfCanStay(Lnet/minecraft/core/world/World;Lnet/minecraft/core/block/Block;Lnet/minecraft/core/world/pos/TilePos;)Z"))
	private boolean alterBlock(
		WorldFeatureNetherScatterBoulderMagmatic instance,
		World world,
		Block<?> bonepile,
		TilePos tilePos,
